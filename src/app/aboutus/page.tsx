...
export default function AboutUs() {
    return (
        <section className="min-h-screen px-6 py-12 bg-transparent text-[#152241]">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <motion.p
                    ...
                    className="text-lg leading-relaxed max-w-3xl mx-auto text-justify"
                >
            ...
            <div className="max-w-5xl mx-auto mt-12">
                <h2 className="text-3xl font-bold text-center mb-8">NUESTROS FUNDADORES</h2>
                <div className="flex flex-col md:flex-row justify-center items-center gap-8">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mt-4">David Espejo</h3>
                        <p className="text-gray-600">CTO - Co Fundador</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mt-4">Paola Lenis</h3>
                        <p className="text-gray-600">CEO - Co Fundadora</p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto mt-16">
                <h2 className="text-3xl font-bold text-center">Misión</h2>
                <p className="text-lg leading-relaxed text-center max-w-3xl mx-auto mt-4 text-justify">
            ...
            {/* Sección de Visión */}
            <div className="max-w-5xl mx-auto mt-16">
                <h2 className="text-3xl font-bold text-center">Visión</h2>
                <p className="text-lg leading-relaxed max-w-3xl mx-auto mt-4 text-justify">
                    <span className="font-bold text-center">El Dinero en Tus Manos, Sin Complicaciones</span>
